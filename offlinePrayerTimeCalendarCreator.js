            ...
            for (const day of response.data) {
                try {
                    ...
                    const entry = {
                        ...
                        "dates": {
                            "gregorian": {
                                "day": parseInt(day.date.gregorian.day),
                                "month": parseInt(day.date.gregorian.month.number),
                                "year": parseInt(day.date.gregorian.year)
                            },
                            "hijri": {
                                "day": parseInt(day.date.hijri.day),
                                "month": parseInt(day.date.hijri.month.number),
                                "year": parseInt(day.date.hijri.year),
                                "monthName": day.date.hijri.month.en
                            }
                        },
